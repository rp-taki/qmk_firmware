 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * | Grv    |   1  |   2  |   3  |   4  |   5  |[Esc] |           |PrtSc |   6  |   7  |   8  |   9  |   0  | BkSpc  |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |LCtrl | LAlt | LGUI | LAlt |[~L1] |                                       | Left | Down |  Up  |Right |[~L1] |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        |[Esc] |[+L1] |       |  [   |   ]  |
 *                                 ,------|------|------|       |------+--------+------.
 *                                 |      |      | Home |       | PgUp |        |      |
 *                                 | Space| BkSpc|------|       |------| [~L1]  |Enter |
 *                                 |      |      | End  |       | PgDn |        |      |
 *                                 `--------------------'       `----------------------'
 */
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_LGUI, KC_LALT, KC_LGUI, KC_LALT, MO(SYMB),
                                             KC_ESC, TG(SYMB),
                                                              KC_HOME,
...
[SYMB] = KEYMAP(
       ...
       KC_F12 , KC_TRNS, KC_TRNS, KC_UP,   KC_TRNS, KC_TRNS, KC_TRNS,
