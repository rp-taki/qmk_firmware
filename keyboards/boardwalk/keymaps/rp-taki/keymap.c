 ...
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+-----------------+--------+--------|
 * | LGUI   | LALT   | LGUI   | LALT   | BACKSP | SPACE  | SPACE  | ENTER  | ENTER  | FN     | LEFT   | DOWN   | UP     | RIGHT  |
 * '-----------------------------------------------------------------------------------------------------------------------------'
 */

 [_1U] = LAYOUT_ortho_5x14(
  KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    RESET,   KC_GRV,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSLS, \
  ...
  KC_LGUI, KC_LALT, KC_LGUI, KC_LALT, KC_BSPC, KC_SPC,  KC_SPC,  KC_ENT,  KC_ENT,  MO(1),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
 ),
 ...
 */
 ...
 [_FN] = LAYOUT_ortho_5x14(
  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   RGB_TOG, RGB_MOD, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  \
  _______, _______, _______, _______, _______, _______, RGB_SAI, RGB_HUI, _______, _______, _______, KC_UP,   _______, _______, \
  _______, _______, _______, _______, _______, _______, RGB_SAD, RGB_HUD, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, \
