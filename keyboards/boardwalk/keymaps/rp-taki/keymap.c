...
/* 1uGrid
 * .-----------------------------------------------------------------------------------------------------------------------------.
 * | ESC    | 1      | 2      | 3      | 4      | 5      | PRINTR | ~      | 6      | 7      | 8      | 9      | 0      | BACKSP |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------|
 * | TAB    | Q      | W      | E      | R      | T      | -      | =      | Y      | U      | I      | O      | P      | |      |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
 * | LCTRL  | A      | S      | D      | F      | G      | [      | ]      | H      | J      | K      | L      | ;      | '      |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
 * | LSHIFT | Z      | X      | C      | V      | B      | ESC    | BACKSP | N      | M      | ,      | .      | /      | RSHIFT |
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+-----------------+--------+--------|
 * | LGUI   | LCTRL  | LALT   | DEL    | FN     | SPACE  | SPACE  | ENTER  | ENTER  | FN     | LEFT   | DOWN   | UP     | RIGHT  |
 * '-----------------------------------------------------------------------------------------------------------------------------'
 */

 [_1U] = LAYOUT_ortho_5x14(
  KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_PSCR, KC_GRV,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC, \
  ...
  KC_LGUI, KC_LCTL, KC_LALT, KC_DEL,  MO(1),   KC_SPC,  KC_SPC,  KC_ENT,  KC_ENT,  MO(1),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
 ),
 ...
 */
 ...
 [_FN] = LAYOUT_ortho_5x14(
  _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   RGB_TOG, RGB_MOD, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_DEL,  \
  _______, KC_F11 , KC_F12,  _______, _______, _______, RGB_SAI, RGB_HUI, _______, _______, KC_UP,   _______, _______, _______, \
  _______, _______, _______, _______, _______, _______, RGB_SAD, RGB_HUD, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, \
