 ...
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+-----------------+--------+--------|
 * | LALT   | LGUI   | LALT   | FN     | BACKSP | SPACE  | SPACE  | ENTER  | ENTER  | FN     | LEFT   | DOWN   | UP     | RIGHT  |
 * '-----------------------------------------------------------------------------------------------------------------------------'
 */
 ...
 [_1U] = LAYOUT_ortho_5x14(
  ...
  KC_LALT, KC_LGUI, KC_LALT, MO(1),   KC_BSPC, KC_SPC,  KC_SPC,  KC_ENT,  KC_ENT,  MO(1),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
 ),
